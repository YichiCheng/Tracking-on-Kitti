...
# 创建输出目录
OUTPUT_PATH = "C:/yichi/PycharmProjects/YOLOv8_Project/TrackEval/data/trackers/kitti/kitti_2d_box_train/T5/data/"
VISUAL_OUTPUT_PATH = "C:/yichi/bt_visual_output4/"
    ...
    for i, image_file in enumerate(image_files):
        ...
        for r in results:
            ...
            for box, score, cls in zip(boxes, scores, classes):
                ...
                cls_list.append(YOLO_CLASS_MAP[cls])  # 转换为 KITTI 类别名称
        ...
        # 运行 ByteTrack 目标跟踪
        if len(detections) > 0:
            tracks = tracker.update(detections, img_info, img_size, frame)
        else:
            tracks = []
